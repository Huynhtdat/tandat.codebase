...
namespace App\Admin\DataTables\Staff;

use App\Admin\DataTables\BaseDataTable;
use App\Admin\Repositories\Staff\StaffRepositoryInterface;
use App\Admin\Traits\GetConfig;

class StaffDataTable extends BaseDataTable
{
    ...
    public function getView(){
        return [
            'action' => 'admin.staffs.datatable.action',
            'editlink' => 'admin.staffs.datatable.editlink',
        ];
    }
    /**
     ...
     */
    public function query(\App\Models\Staff $model)
    {
    ...
    protected function setCustomColumns(){
        $this->customColumns = $this->traitGetConfigDatatableColumns('staff');
    }
    ...
    protected function editColumnGender(){
        $this->instanceDataTable = $this->instanceDataTable->editColumn('gender', function($staff){
            return $staff->gender->description();
        });
    }
    protected function editColumnRoles(){
        $this->instanceDataTable = $this->instanceDataTable->editColumn('roles', function($staff){
            return $staff->roles->description();
        });
    }
    ...
    protected function htmlParameters(){
        ...
        $this->parameters['initComplete'] = "function () {
            ...
            moveSearchColumnsDatatable('#staffTable');
